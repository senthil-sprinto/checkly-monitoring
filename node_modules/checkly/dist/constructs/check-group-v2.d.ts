 ...
 *       individual check settings to take effect.
 */
export declare class CheckGroupV2 extends CheckGroupV1 {
    constructor(logicalId: string, props: CheckGroupV2Props);
    describe(): string;
    onBeforeValidate(diagnostics: Diagnostics): Promise<void>;
    ...
    synthesize(): {
        ...
        apiCheckDefaults: import("./api-check.js").ApiCheckDefaultConfig;
