...
export class DnsAssertionBuilder {
     ...
     */
    static responseCode() {
        return new GeneralAssertionBuilder('RESPONSE_CODE');
    }
    /**
    ...
    static textAnswer(regex) {
        return new GeneralAssertionBuilder('TEXT_ANSWER', regex);
    }
    /**
    ...
    static jsonAnswer(property) {
        return new GeneralAssertionBuilder('JSON_ANSWER', property);
    }
}
