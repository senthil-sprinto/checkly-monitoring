...
import { ExponentialRetryStrategy, FixedRetryStrategy, LinearRetryStrategy, NoRetriesRetryStrategy, SingleRetryRetryStrategy } from './retry-strategy.js';
import { Check, CheckProps } from './check.js';
import { Diagnostics } from './diagnostics.js';
/**
 * Retry strategies supported by monitors.
 */
export type MonitorRetryStrategy = LinearRetryStrategy | ExponentialRetryStrategy | FixedRetryStrategy | SingleRetryRetryStrategy | NoRetriesRetryStrategy;
...
export declare abstract class Monitor extends Check {
