 ...
 */
export declare class StatusPageServiceRef extends Construct {
 ...
 */
export declare class StatusPageService extends Construct {
    name: string;
     ...
     */
    static fromId(id: string): StatusPageServiceRef;
    synthesize(): any | null;
}
