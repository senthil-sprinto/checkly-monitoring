...
export class Construct {
    ...
    async validate(diagnostics) {
        if (!LOGICAL_ID_PATTERN.test(this.logicalId)) {
            diagnostics.add(new InvalidPropertyValueDiagnostic('logicalId', new Error(`"${this.logicalId}" contains invalid characters. Only A-Z, a-z, 0-9, _, -, /, #, and . are allowed.`)));
        }
    }
    /**
 ...
 */
export function isEntrypoint(value) {
