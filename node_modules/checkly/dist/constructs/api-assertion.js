...
export class AssertionBuilder {
     ...
     */
    static statusCode() {
        return new NumericAssertionBuilder('STATUS_CODE');
    }
    /**
    ...
    static jsonBody(property) {
        return new GeneralAssertionBuilder('JSON_BODY', property);
    }
    /**
    ...
    static headers(property, regex) {
        return new GeneralAssertionBuilder('HEADERS', property, regex);
    }
    /**
