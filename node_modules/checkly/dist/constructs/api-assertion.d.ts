...
export declare class AssertionBuilder {
     ...
     */
    static statusCode(): NumericAssertionBuilder<ApiAssertionSource, string>;
    /**
     ...
     */
    static responseTime(): NumericAssertionBuilder<ApiAssertionSource, string>;
    /** @deprecated Use {@link responseTime()} instead */
    static responseTme(): NumericAssertionBuilder<ApiAssertionSource, string>;
}
export {};
