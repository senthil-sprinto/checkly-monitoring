...
export declare class TcpAssertionBuilder {
     ...
     */
    static responseTime(): NumericAssertionBuilder<TcpAssertionSource, string>;
}
/**
 ...
 */
export declare class TcpMonitor extends Monitor {
    request: TcpRequest;
    degradedResponseTime?: number;
    maxResponseTime?: number;
    /**
...
export { TcpMonitorProps as TcpCheckProps, TcpMonitor as TcpCheck, };
