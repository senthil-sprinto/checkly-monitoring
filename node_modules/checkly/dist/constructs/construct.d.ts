 ...
 */
export declare abstract class Construct implements Validate, Bundle {
    /** The type identifier of the construct */
    type: string;
    /** Unique logical identifier within the project scope */
    logicalId: string;
     ...
     */
    bundle(bundler: Bundler): Promise<Bundle>;
    /**
     * Synthesizes the construct into its deployable representation.
 ...
 */
export declare function isEntrypoint(value: any): value is Entrypoint;
/**
