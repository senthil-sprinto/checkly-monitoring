...
type IcmpAssertionSource = 'LATENCY' | 'JSON_RESPONSE';
 ...
 * ```
 */
export declare class IcmpAssertionBuilder {
    /**
     ...
     */
    static latency(property: IcmpLatencyProperty): NumericAssertionBuilder<IcmpAssertionSource, IcmpLatencyProperty>;
    /**
