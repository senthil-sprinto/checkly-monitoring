...
const accountMemberUpdateRoles = ['ADMIN', 'READ_WRITE', 'READ_RUN', 'READ_ONLY'];
const accountMemberUpdateRoleOptions = accountMemberUpdateRoles.map(role => role.toLowerCase());
function isAccountMemberUpdateRole(value) {
    return accountMemberUpdateRoles.includes(value);
}
export function normalizeAccountMemberUpdateRole(value) {
