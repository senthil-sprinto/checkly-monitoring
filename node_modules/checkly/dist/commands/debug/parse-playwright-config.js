...
export default class ParsePlaywrightConfigCommand extends Command {
    ...
    async run() {
        ...
        const { file: playwrightConfigFile, } = flags;
        const playwrightConfig = new PlaywrightConfig(playwrightConfigFile, await Session.loadFile(playwrightConfigFile));
...
//# sourceMappingURL=parse-playwright-config.js.map