...
import { Diagnostics, Session, } from '../../constructs/index.js';
...
export default class ParseProjectCommand extends Command {
    ...
    async run() {
        ...
        const { config: configFilename, 'default-runtime': defaultRuntime, 'verify-runtime-dependencies': verifyRuntimeDependencies, 'emulate-pw-test': emulatePwTest, 'include': includeFlag, 'inject-private-location': injectPrivateLocation, 'stats': stats, } = flags;
