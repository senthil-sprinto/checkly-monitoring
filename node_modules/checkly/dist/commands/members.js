...
import { formatAccountMembers, formatCursorNavigationHints, formatCursorPaginationInfo, } from '../formatters/account-members.js';
...
export function normalizeAccountMemberType(value) {
    if (value === undefined)
        return undefined;
    const normalized = value.trim().toLowerCase();
    return isAccountMemberType(normalized) ? normalized : undefined;
}
export function normalizeAccountMemberRole(value) {
    if (value === undefined)
        return undefined;
    const normalized = value.trim().toUpperCase();
    return isAccountMemberRole(normalized) ? normalized : undefined;
}
export function normalizeAccountMemberStatus(value) {
    if (value === undefined)
        return undefined;
    const normalized = value.trim().toUpperCase();
