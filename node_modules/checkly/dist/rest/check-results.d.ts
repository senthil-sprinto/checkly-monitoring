...
declare class CheckResults {
    api: AxiosInstance;
    constructor(api: AxiosInstance);
    getAll(checkId: string, params?: ListCheckResultsParams): Promise<import("axios").AxiosResponse<CheckResultsPage, any, {}>>;
    get(checkId: string, checkResultId: string): Promise<import("axios").AxiosResponse<CheckResult, any, {}>>;
}
