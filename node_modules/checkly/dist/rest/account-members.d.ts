...
declare class AccountMembers {
    api: AxiosInstance;
    constructor(api: AxiosInstance);
    getAll(params?: AccountMembersListParams): Promise<import("axios").AxiosResponse<AccountMembersResponse, any, {}>>;
    updateRole(userId: string, role: AccountMemberUpdateRole): Promise<import("axios").AxiosResponse<ActiveAccountMember, any, {}>>;
    delete(userId: string): Promise<import("axios").AxiosResponse<void, any, {}>>;
}
