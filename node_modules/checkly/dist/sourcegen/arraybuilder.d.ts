import { ObjectValueBuilder } from './objectbuilder.js';
import { ArrayValue } from './array.js';
import { Value } from './value.js';
import { ExpressionValueBuilder } from './exprbuilder.js';
export declare function array(build: (builder: ArrayValueBuilder) => void): ArrayValue;
export declare class ArrayValueBuilder {
    #private;
    empty(): this;
