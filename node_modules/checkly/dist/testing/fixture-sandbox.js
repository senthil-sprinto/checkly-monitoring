...
export class FixtureSandbox {
    ...
    static async create(options) {
        const { source, root: maybeRoot, packageManager: maybePackageManager, template = 'bare', } = options;
        ...
        if (template) {
            ...
            await fs.symlink(path.join(resolvedTemplate.root, 'node_modules'), path.join(root, 'node_modules'), 'dir');
            ...
            if (!hasLockfile) {
                await fs.copyFile(path.join(resolvedTemplate.root, 'pnpm-lock.yaml'), path.join(root, 'pnpm-lock.yaml'));
            }
        }
