...
export function findPropertyByName(ast, name) {
    let node;
    recast.visit(ast, {
        visitProperty(path) {
...
export function addOrReplaceItem(ast, node, name) {
...
export function addItemToArray(ast, node, name) {
...
export async function reWriteChecklyConfigFile(data, fileName, dir) {
