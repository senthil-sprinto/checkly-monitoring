...
import { renderAdaptiveTable, renderDetailFields, formatDate, timeAgo, } from './render.js';
...
export function formatIncidentSeverity(severity, format) {
...
export function formatIncidentStatus(status, format) {
...
export function formatIncidentsList(incidents, format) {
...
export function formatIncidentDetail(incident, format) {
    const lines = [];
...
export function formatIncidentUpdateDetail(incidentId, update, format, title = 'Incident Update') {
