...
import { renderAdaptiveTable, renderCommandHints, renderDetailFields, } from './render.js';
...
export function formatStatusPagesExpanded(statusPages, format) {
...
export function formatStatusPagesCompact(statusPages, format) {
    const columns = buildCompactColumns(format);
    return renderAdaptiveTable(columns, statusPages, format);
}
// --- Cursor pagination helpers ---
export function formatCursorPaginationInfo(count, nextId) {
...
export function formatCursorNavigationHints(nextId) {
    if (!nextId)
        return '';
...
export function formatStatusPageDetail(sp, format) {
    const lines = [];
