...
export default class AbstractCheckRunner extends EventEmitter {
    checks;
    testSessionId;
    ...
    detach;
    queue;
    constructor(accountId, timeout, verbose, detach = false) {
        super();
        this.checks = new Map();
    ...
    async run() {
        ...
        try {
            ...
            previousSigintListeners = process.rawListeners('SIGINT');
