...
export function isBuiltinPath(importPath) {
 ...
 */
export function isNativeBinaryPath(importPath) {
    return importPath.endsWith('.node');
}
export function isImportsPath(importPath) {
    if (importPath.startsWith('#')) {
        return true;
    }
    return false;
}
export function splitExternalPath(importPath) {
    if (importPath.startsWith('@')) {
