...
export interface Reporter {
    ...
    onStreamLogs(check: any, sequenceId: SequenceId, logs: Array<{
        timestamp: number;
        message: string;
    }>): void;
    onCancel(): void;
...
export declare const createReporters: (types: ReporterType[], runLocation: RunLocation, verbose: boolean, options?: ReporterOptions) => Reporter[];
